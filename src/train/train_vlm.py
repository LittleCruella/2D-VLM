...
# Các hàm đơn giản hóa sau khi bỏ distributed
def rank0_print(*args):
    # Khi không có distributed, luôn in ra
    print(*args)
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    seed: int = 42
    # Loại bỏ ddp_backend, ddp_timeout, ddp_find_unused_parameters
...
# Loại bỏ các hàm maybe_zero_3 và get_mm_projector_state_maybe_zero_3
